        ...
        <div class="row">
            <div class="col-lg-3 col-sm-12">
                <div class="mt-2 p-2" style="border: 2px dashed #002aff;border-radius: 10px">
                    <div class="w-100 p-2 justify-content-center align-content-center" style="border-radius: 8px">
                        <button wire:click="new_chat()" style="border-radius: 8px;background-color: #8bb7f6;color: #FFFFFF" class="mb-3 w-100 c-shadow btn btn-light-primary">
                            ایجاد پیام</button>
                        @foreach($chats ?? [] as $item)
                            <button wire:click="set_chat({{$item->id}})"
                                    style="border-radius: 8px"
                                    class="mb-3 w-100 c-shadow btn btn-light-primary">
                                {{$item->title}}
                            </button>
                        @endforeach
            ...
            @if($form_chat)
                <div class="col-lg-9 col-sm-12">
                    <div class="mt-2 p-5" style="border: 2px dashed #002aff;border-radius: 10px">
                        <div class="">
                ...
                <div class="col-lg-9 col-sm-12">
                    <div class="mt-2 p-4" style="border: 2px dashed #002aff;border-radius: 10px">
                        <button
                                ...
                                class="mb-3  c-shadow btn btn-light-primary">
                            {{$chat->title}}</button>
                        <div class="c-shadow chat-page p-3">
                            @foreach($chat->messages ?? [] as $message)
                                @if($message->sender_id == auth()->user()->id)
                                    <div class="message-container" style="text-align: right;">
                                        <div class="message bg-primary text-white p-2 mb-4" style="max-width: 75%; display: inline-block; border-radius: 8px;">
                                ...
                                @else
                                    <div class="message-container" style="text-align: left;">
                                        <div class="message bg-light text-dark p-2 mb-4" style="max-width: 75%; display: inline-block; border-radius: 8px;">
                                            <p class="mb-1">{{ $message->message }}</p>
                                            <div class="d-flex">
